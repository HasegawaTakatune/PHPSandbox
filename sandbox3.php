...
<body>
  <form action="" method="POST">
    ...
    if (isset($_POST['radio1']))
      $radioChecked = $_POST['radio1'];
    ?>
    <input type="radio" name="radio1" value="0" <?php if ($radioChecked == 0)
      echo 'checked' ?>>剣
      <input type="radio" name="radio1" value="1" <?php if ($radioChecked == 1)
      echo 'checked' ?>>盾
      <input type="radio" name="radio1" value="2" <?php if ($radioChecked == 2)
      echo 'checked' ?>>鎧
