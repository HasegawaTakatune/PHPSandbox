...
<div id="content">
    ...
    <table>
        ...
        <tr>
            ...
            <td class="label02"><input type="text" value="<?=htmlspecialchars($row["last_name"] . "&nbsp" . $row["first_name"], ENT_QUOTES)?>" style="width: 120px;" class="inputItem01-disabled" disabled></td>
            <td><div class="label01">メール</div></td>
            <td class="label02"><input type="text" value="<?=htmlspecialchars($row["email"], ENT_QUOTES)?>" style="width: 250px;" class="inputItem01-disabled" disabled></td>
            <td><div class="label01" style="width: 70px;">電話</div></td>
            <td class="label02"><input type="text" value="<?=htmlspecialchars($row["tell"], ENT_QUOTES)?>" style="width: 120px;" class="inputItem01-disabled" disabled></td>
        </tr>
    </table>
    ...
    <div class="scrollBox02">
        <table>
            ...
            <tr>
                ...
                <td class="label01"><?=htmlspecialchars($row["product"], ENT_QUOTES)?></td>
